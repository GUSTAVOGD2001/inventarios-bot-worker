...
from .routers import exemptions, inventory, prices, pricing, settings as settings_router, shopify as shopify_router, skus, stats, worker
...
app.include_router(shopify_router.router, prefix="/api/v1", tags=["shopify"])
